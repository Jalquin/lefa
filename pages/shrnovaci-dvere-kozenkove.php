    ...
    <div class="row flex-row-reverse">
        ...
        <div class="col-lg-9 mb-4 mb-lg-0">
            ...
            <ul>
                ...
                <li>úchyt – BLANKA</li>
                <li>uzavírání dveří - magnetickým zámkem do železné dorazové lišty</li>
                <li>uzamykání mechanickým kovovým zámkem</li>
                <li>prosklení okének z akrylátu NIAGÁRA čirá nebo kouřová</li>
                <li>rámeček prosklení v bílé nebo hnědé barvě</li>
                <li>maximální výška dveří 215 cm</li>
            </ul>
