<section class="container">
    <div class="row">
        ...
        <div class="col-lg-9 mb-4 mb-lg-0">
            ...
            <iframe height="500" width="100%" src="documents/zatemneni/technicky-vykres.pdf"></iframe>
            <iframe height="500" width="100%" src="documents/zatemneni/vzornik-barev.pdf"></iframe>

            <div class="page-slider mt-2" id="page-slider">
                <div class="item">
                    <img alt="project-slider-image" class="project-slider-image img-fluid"
                         src="images/services/interior/zatemneni/zatemneni.jpg"/>
                </div>
            </div><!-- Page slider end -->
