    ...
    <div class="banner-carousel-item" style="background-image:url(images/slider/venkovni-rolety-drevene4.jpg)">
        <div class="slider-content text-left">
            <div class="container h-100">
                <div class="row align-items-center h-100">
                    <div class="col-md-12">
                        <h2 class="slide-title-box" data-animation-in="slideInDown">Profesionální přístup</h2>
            ...
            <div class="row align-items-center">
                <div class="col-md-8 text-center text-md-left">
                    <div class="call-to-action-text">
                        <h3 class="action-title">Rozumíme vašim potřebám v oblasti <b>stínící techniky</b></h3>
                    </div>
                </div><!-- Col end -->
